...
export const InvitationSection: React.FC = () => {
  ...
  return (
    <section id="invitation" className="relative py-16 sm:py-24 px-4 bg-emerald-950 text-ivory-50 flex justify-center overflow-hidden">
      ...
      <div className="w-full max-w-lg relative z-10">
        <motion.div
          ...
          className="relative glass-emerald-card rounded-3xl p-6 sm:p-10 border border-gold-500/25 shadow-soft-xl text-center overflow-hidden"
        >
          ...
          <div className="relative inline-flex items-center justify-center mb-4">
            <div className="w-12 h-12 rounded-full bg-gold-gradient text-emerald-950 flex items-center justify-center border-2 border-gold-200/40 shadow-gold-glow">
              <HeartHandshake className="w-6 h-6 stroke-[2]" />
            </div>
          </div>

          <h2 className="font-serif text-2xl sm:text-3xl font-bold tracking-wider text-gold-200 uppercase mb-2">
            {t.invitation.title}
          </h2>

          <AnimatedFlourishDivider className="my-3 text-gold-500/60" />
          ...
          <div className="space-y-5 text-base sm:text-lg text-ivory-100/90 leading-relaxed font-serif px-2 sm:px-4 tracking-normal relative z-10 text-center max-w-xl mx-auto">
                ...
                lang === "vi" ? (
                  pronounMode === "elder" ? (
                    <>
                      ...
                      <strong className="text-gold-200 font-semibold underline decoration-gold-500/50 underline-offset-4">
                        {guestName}
                      </strong>{" "}
            ...
            {customMessage && (
              <motion.div
                ...
                className="mt-6 p-4 sm:p-5 rounded-2xl bg-emerald-900/60 border border-gold-500/25 text-left relative"
              >
                <div className="flex items-center gap-1.5 text-gold-200 font-sans text-[11px] sm:text-xs font-semibold uppercase tracking-wider mb-2">
                  <Sparkles className="w-3.5 h-3.5 text-gold-500" />
                  <span>Đôi lời gửi gắm riêng đến {guestName}:</span>
                </div>
                <p className="font-serif italic text-base sm:text-lg text-ivory-100 leading-relaxed">
          ...
          <div className="mt-8 pt-6 border-t border-gold-500/25 flex flex-col items-center relative z-10">
            <span className="font-serif italic font-normal text-gold-200 text-2xl sm:text-3xl tracking-wide">
              {graduationConfig.name}
            </span>
            <span className="text-[11px] font-sans text-emerald-400 font-semibold uppercase tracking-[0.25em] mt-1">
