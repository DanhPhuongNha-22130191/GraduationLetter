...
export const translations: Record<Language, TranslationSchema> = {
  vi: {
    ...
    gallery: {
      ...
      uploadSelectFile: "Bấm hoặc kéo thả ảnh vào đây (tối đa 12 ảnh mỗi lần)",
  ...
  en: {
    ...
    gallery: {
      ...
      uploadSelectFile: "Click or drag & drop photos here (up to 12 photos per upload)",
  ...
  km: {
    nav: {
      ...
      rsvp: "ការចូលរួម",
      envelope: "ត្រឡប់ក្រោយ",
      backToEnvelope: "ត្រឡប់ក្រោយ",
    },
    hero: {
    ...
    gallery: {
      ...
      uploadSelectFile: "ចុច ឬទម្លាក់រូបថតនៅទីនេះ (អតិបរមា ១២ រូបក្នុងមួយលើក)",
